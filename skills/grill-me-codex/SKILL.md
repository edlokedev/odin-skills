---
name: grill-me-codex
description: Two-act plan hardening. Act 1: Claude interviews you one question at a time until the plan's decision tree is resolved. Act 2: Claude writes the locked plan to PLAN.md and OpenAI Codex adversarially reviews it read-only (VERDICT:APPROVED/REVISE) across the same session until APPROVED or MAX_ROUNDS, then you sign off before any code. Use for high-stakes work (auth, schema, concurrency, migrations, payments) when you want both alignment and a cross-model check. Triggers: "/grill-me-codex", "grill me then have codex review". Docs-aware variant: /grill-with-docs-codex; plan-only review: /codex-review. Builds on Matt Pocock's grill-me (MIT). Not for reviewing existing code or trivial changes.
---
